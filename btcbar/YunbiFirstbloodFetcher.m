...
@implementation YunbiFirstbloodFetcher
...
- (id)init
{
  ...
  {
    // Menu Item Name
    self.ticker_menu = @"云币 1ST";
    
    // Website location
    self.url = @"https://yunbi.com/markets/1stcny";
...
- (void)requestUpdate
{
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://yunbi.com/api/v2/tickers/1stcny.json"]];
  
  // Set the request's user agent
  [request addValue:@"btcbar/2.0 (YunbiFirstbloodFetcher)" forHTTPHeaderField:@"User-Agent"];
