...
@implementation YunbiZecFetcher
...
- (id)init
{
  ...
  {
    // Menu Item Name
    self.ticker_menu = @"云币 ZEC";
    
    // Website location
    self.url = @"https://yunbi.com/markets/zeccny";
...
- (void)requestUpdate
{
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://yunbi.com/api/v2/tickers/zeccny.json"]];
  
  // Set the request's user agent
  [request addValue:@"btcbar/2.0 (YunbiZecFetcher)" forHTTPHeaderField:@"User-Agent"];
